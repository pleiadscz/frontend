...
>
        ...
        <div class="flex-auto w-0 max-w-full pl-1">
                ...
                <div class="chat-{message.role} w-full min-w-full markdown-prose text-black font-medium dark:text-white">
                        {#if edit !== true}
                                {#if message.files}
                                        <div
                                                ...
                                                >
                                                        {#if message.content}
                                                                {#if $settings?.renderMarkdownInUserMessages ?? true}
                                                                        ...
                                                                        />
                                                                {:else}
                                                                        <div class="whitespace-pre-wrap font-medium text-black dark:text-white" dir={$settings?.chatDirection ?? 'auto'}>
                                                                                {message.content}
                                                                        </div>
                                                                {/if}
                                                        {/if}
