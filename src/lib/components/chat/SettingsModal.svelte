...
<Modal size="2xl" bind:show>
        <div class="text-gray-700 dark:text-gray-100 mx-1">
                <div class="md:hidden mx-auto mb-5 h-1 w-10 rounded-full bg-neutral-300 dark:bg-neutral-600"></div>
                ...
                <div class="flex flex-col md:flex-row w-full pt-1 pb-4">
                        <div
                                ...
                                class="tabs grid grid-cols-3 gap-3 md:pr-4 md:gap-1 md:flex-col flex-1 md:flex-none md:w-50 md:min-h-[min(42rem,calc(100dvh-10rem))] md:max-h-[min(42rem,calc(100dvh-10rem))] dark:text-gray-200 text-sm text-left mb-1 md:mb-0 -translate-y-1"
                        >
                                <div
                                        ...
                                        {#each filteredSettings as tabId (tabId)}
                                                {#if tabId === 'general'}
                                                        <button
                                                                ...
                                                                class={`px-0.5 md:px-2.5 py-3 md:py-1 md:min-w-fit rounded-xl flex-1 md:flex-none flex flex-col items-center justify-center gap-2 md:flex-row md:items-start text-center md:text-left transition
                                                                ${
                                                                        selectedTab === 'general'
                                ...
                                {#if $user?.role === 'admin'}
                                        <a
                                                href="/admin/settings"
                                                draggable="false"
                                                class="px-0.5 md:px-2.5 py-1 min-w-fit rounded-xl flex-1 md:flex-none md:mt-auto flex select-none text-center md:text-left transition {$settings?.highContrastMode
                                                        ? 'hover:bg-gray-200 dark:hover:bg-gray-800'
                                                        : 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
                                                on:click={async (e) => {
                                                        e.preventDefault();
