        ...
        {#if show}
                ...
                >
                        <div
                                class="z-[9999] {$mobile
                                        ? `w-[220px]`
                                        : `${className}`} max-w-[calc(100vw-1rem)] justify-start p-1 rounded-2xl bg-white dark:bg-[#141414] shadow-lg border-[1.5px] border-gray-100 dark:border-[#272727] outline-hidden overflow-hidden"
                        >
                                <slot>
